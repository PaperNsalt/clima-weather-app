...
import { motion, useScroll, useSpring } from "framer-motion"; // Added Framer Motion imports
...
function HomePage() {
  ...
  // Smooth out the scroll progress so the line doesn't jitter
  ...
  return (
    // --- 2. WRAPPER DIV WITH REF (Relative positioning for SVG) ---
    <div ref={containerRef} className="relative w-full min-h-screen pb-20">
      
      {/* --- 3. BACKGROUND SVG LINE ANIMATION --- */}
      <div className="absolute top-0 left-0 w-full h-full -z-10 overflow-hidden pointer-events-none">
        <svg
          className="w-full h-full opacity-40 md:opacity-60"
          viewBox="0 0 400 1400" // Tall viewbox for vertical scroll
        ...
        >
          ...
          {/* The Animated Line (Fills on scroll) */}
          <motion.path
            d="M 200 0 
               Q 200 100, 100 200 
               T 100 400 
            ...
            strokeLinecap="round"
            fill="none"
            style={{ pathLength }} // Binds the length to scroll
          />
        </svg>
      </div>

      {/* --- EXISTING CONTENT (Wrapped in Z-Index to stay on top) --- */}
      <div className="relative z-10"> 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6 md:mt-10">
            ...
            <div className="lg:col-span-2 relative flex flex-col p-6 md:p-10 rounded-3xl shadow-xl overflow-hidden border border-white/20">
              ...
              <div className="relative z-10 flex flex-col h-full justify-between">
                {loading && (
                  <div className="absolute inset-0 bg-white/30 rounded-3xl flex items-center justify-center backdrop-blur-md z-50"></div>
                )}
        ...
        {weather && (
          <section className="max-[426px]:ml-4 max-[426px]:mr-4 mt-6 md:mt-10 mx-auto max-w-7xl mb-8 bg-[#61bdf2] rounded-3xl p-4 md:p-8 shadow-md overflow-hidden relative">
